        ...
        //Notas del alumno POST
            ...
            for ($i=1; $i <= $anio; $i++) { 
                ...
                for ($k=0; $k < $cantidadM[$i]; $k++) { 
                    ...
                    //nombre materias
                        if (!empty($_POST['nombreM_'.$i.'_'.$k.''])) {
                            $nombreM[$i][$k] = $_POST['nombreM_'.$i.'_'.$k.''];
                        }else {
                            $nombreM[$i][$k] = "****";
                        }
                    //notas de las materias
                        if (!empty($_POST['nombreN_'.$i.'_'.$k.''])) {
                    ...
                    //periodo de la nota
                        if (!empty($_POST['periodoN_'.$i.'_'.$k.''])) {
                    ...
                    //promedio de la materia
                        if (!empty($_POST['promedio_'.$i.'_'.$k.''])) {
            ...
            //Si no es de 5to año se rellenan los espacios en blanco
            if ($aniomax < 5) {
                $aniomax++;
                for ($i=$aniomax; $i <= 5; $i++) { 
