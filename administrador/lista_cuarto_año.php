<?php
    ...
    $sql = "SELECT * FROM cuarto_año as sg INNER JOIN alumnos as al ON sg.alumno_id = al.alumno_id INNER JOIN aulas as au ON sg.aula_id = au.aula_id INNER JOIN periodos as pe ON sg.periodo_id = pe.periodo_id INNER JOIN menciones as me ON sg.mencion_id = me.mencion_id WHERE sg.statuscr != 0 AND sg.aula_id = $seccion ORDER BY al.cedulaes";
